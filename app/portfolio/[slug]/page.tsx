...
const projects: Record<string, any> = {
  ...
  "tradevilles": {
    ...
    description: "A comprehensive trading education platform designed to teach people how to trade from zero. Features an interactive learning journey with step-by-step progression, TradingView integration, real-time market analysis, and progress tracking.",
    image: "/images/tradevilles-1.png",
    tags: ["TradingView", "Interactive", "Education", "React", "Frontend"],
    client: "Tradesvilles",
    ...
    approach:
      "We built a comprehensive trading education platform with an interactive frontend featuring imported TradingView features. Created a structured 10-step learning journey covering basics, terminology, tools, structure, and strategies. Implemented progress tracking with quiz requirements, trade logging, and milestone achievements. Integrated real-time market analysis with bull market indicators, peak probability calculations, and phase detection. The platform guides users from absolute beginner to confident trader through carefully crafted educational content.",
    results: [
      "Interactive learning journey with 10 structured steps",
      "TradingView features seamlessly integrated",
      "Real-time market analysis with phase detection",
      "Progress tracking system with quiz requirements",
      "Step-by-step progression from basics to advanced strategies",
      "Engaging user experience with milestone achievements",
      "Comprehensive educational content (candlesticks, terminology, tools, strategies)",
      "Bull market analysis with peak probability indicators",
    ],
    screenshots: [
      "/images/tradevilles-1.png",
      "/images/tradevilles-2.png",
      "/images/tradevilles-3.png",
    ],
    testimonial: {
      quote:
